...
local shoot = display.newImageRect( "jumpButton.png", 50, 50 )
...
local sheetIdleNinja = graphics.newImageSheet( "ninjaBoyIdle.png", sheetOptionsIdle )
...
local sheetWalkingNinja = graphics.newImageSheet( "ninjaBoyThrow.png", sheetOptionsWalk )
...
local function shootTouch ( event )   
    ...
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImageRect( "kunai.png", 50, 100 )
        ...
        aSingleBullet:setLinearVelocity( 10, 0 )
...
local sheetWalkingNinja = graphics.newImageSheet( "ninjaBoyDead.png", sheetOptionsWalk )
